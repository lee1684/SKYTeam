...
export class ScenegraphService {
  ...
  private _mobileTicket: MobileTicket | null = null;
  constructor() { 
  ...
  public initThree(): void {
    ...
    */
    ...
    this._mobileTicket =  new MobileTicket(this);
    this._mobileTicket.initMobileTicket();
    startAnimation(this);
  ...
  private createArcballControls():void{
      this.arcballControls = new ArcballControls( this.camera!, this.css3dRenderer!.domElement, this.scene! );
      ...
      this.arcballControls.addEventListener( 'change', ()=> {
        ...
        this._mobileTicket?.checkFaceVisible();
      });
