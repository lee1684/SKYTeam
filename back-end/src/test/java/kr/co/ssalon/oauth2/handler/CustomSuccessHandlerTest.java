...
public class CustomSuccessHandlerTest {
    ...
    public void getUsernameAndEmailAndRole() {
        // 소셜로부터 가져온 유저(@WithCustomMockUser)의 username, email, role 가져오기
    ...
    public void 토큰response() throws Exception {
        ...
        // RedisRefreshTokenRepository stub
        RedisRefreshToken redisRefreshToken = new RedisRefreshToken();
        when(redisRefreshTokenRepository.save(redisRefreshToken)).thenReturn(redisRefreshToken);
